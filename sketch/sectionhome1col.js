...
function setbodies() {
  ...
  bottom = Bodies.rectangle((w1 / 2)+64, h1, w1-128, 2, { isStatic: true });
  left = Bodies.rectangle(2+64, h1 / 2, 2, h1, { isStatic: true });
  right = Bodies.rectangle(w1 - 2, h1 / 2, 2, h1, { isStatic: true });
  roof = Bodies.rectangle((w1 / 2)+64, 0, w1-128, 2, { isStatic: true });
  ...
  pad = 0.06 * h1;
  parts.push(
    Bodies.rectangle((w1 / 2)+64, h1 - pad, w1- 128- pad * 2, 1, { isStatic: false }),
    Bodies.rectangle(pad+64, h1 / 2, 1, h1 - pad * 2, { isStatic: false }),
    Bodies.rectangle(w1- pad, h1 / 2, 1, h1 - pad * 2, { isStatic: false }),
    Bodies.rectangle((w1 / 2)+64, pad, w1 - 128- pad * 2, 1, { isStatic: false })
  );
